 ...
 * author sc
 * description :
 * Node有两个指针next和rand，next指向下一个节点，rand指向任意节点
 * 给定一个由Node节点类型组成的无环单链表的头节点head，请实现一个函数完成这个链表所有结构的复制，
 * 并返回复制的新链表的头节点。
 * 进阶：不使用额外的数据结构，只用有限几个变量，并在时间复杂度为O(N)内完成。
 *
 * date 2018-09-25
 * */
